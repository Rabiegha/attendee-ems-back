...
const systemRolesTemplates: RoleSeedData[] = [
  ...
  },
  {
    code: 'ADMIN',
    name: 'Administrator',
    description: 'Template - Full management of organization. Cannot modify own role.',
    level: 1,
    is_system_role: true,
  },
  {
    code: 'MANAGER',
    name: 'Manager',
    description: 'Template - Event and attendee management.',
    level: 2,
    is_system_role: true,
  },
  {
    code: 'PARTNER',
    name: 'Partner',
    description: 'Template - Access to assigned events only.',
    level: 3,
    is_system_role: true,
  },
  {
    code: 'VIEWER',
    name: 'Viewer',
    description: 'Template - Read-only access.',
    level: 4,
    is_system_role: true,
  },
  {
    code: 'HOSTESS',
    name: 'Hostess',
    description: 'Template - Check-in for assigned events.',
    level: 5,
    is_system_role: true,
  },
];
